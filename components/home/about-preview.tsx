...
const highlights = [
  ...
  },
  {
    ...
    title: "Full Stack",
    description:
      "From database design to pixel-perfect interfaces, I do it all.",
  },
  {
    icon: Zap,
    title: "Performance",
          ...
          <div>
            ...
            <FadeIn delay={0.2}>
              <p className="text-muted-foreground text-lg leading-relaxed mb-8 text-pretty">
                ...
                perspective on what makes software truly exceptional.
              </p>
            </FadeIn>
            ...
            <FadeIn delay={0.3}>
              <Button
                asChild
                variant="outline"
                className="group border-primary/30 hover:bg-primary/10 bg-transparent">
                <Link href="/about">
                  Read My Full Story
